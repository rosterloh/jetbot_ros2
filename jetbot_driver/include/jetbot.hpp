...
protected:
  ...
  /// Speed (m/s) this jetbot will attain running its motors at full power
  /// forward.
  double top_speed_linear;
  /// Rotational speed (rad/s) this jetbot will attain pushing its motors at full
  /// effort in opposite directions
  double top_speed_angular;

  /// Describes the relation between the encoder frequencies and the jetbot
  /// velocity
  ...
  void on_raw_data(jetbot_msgs::msg::RawData::ConstSharedPtr data);
  ...
  /// Subscription for raw data coming from the jetbot
  rclcpp::Subscription<jetbot_msgs::msg::RawData>::SharedPtr sub_raw_data;
  /// Publisher for efforts going to the jetbot
  rclcpp::Publisher<jetbot_msgs::msg::RawMotorCommand>::SharedPtr pub_motor_efforts;
  rclcpp::Publisher<jetbot_msgs::msg::RawCommand>::SharedPtr pub_jetbot_command;
