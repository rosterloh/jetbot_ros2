...
{
  static int16_t decode(jetbot::data::RawValue r) { return as_int16(r); }
};
...
struct JetBotVersion : KnownDataElement<40, JetBotVersionValue>
{
  static Value decode(RawValue r)
  {
    auto v = as_uint16(r);
...
enum class MotorStatusFlag {
  ...
  /// or counterclockwise, NOT forward or backwards w.r.t. the jetbot's heading)
  /// Ignored when coasting or braking.
